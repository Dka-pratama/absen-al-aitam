    ...
    public function search(Request $r)
{
    ...
    $data = Siswa::with([
            'user',
            'kelasSiswa' => function ($q) {
                $q->whereHas('tahunAjar', fn($q2) => $q2->where('status', 'aktif'))
                  ->with('kelas');
            }
        ])
    ...
    public function importExport()
{
    ...
    return view('admin.siswa.import-export', compact('kelas'));
}
public function template()
{
    $data = [
        ['NISN', 'Nama', 'Username', 'Password'],
        ['1234567890', 'Budi Santoso', 'budi', '123456'],
    ];
...
public function exportUpdate(Request $request)
{
    ...
    $data = [
        ['siswa_id', 'user_id', 'NISN', 'Nama', 'Username', 'Password'],
    ];
