        ...
        <div x-data="{ open: false }" class="mb-6">
            ...
            >
                <div>
                    ...
                    <p class="text-xs text-gray-500">Status Global & Lokasi Absensi</p>
                </div>
                <span class="text-xl transition-transform duration-200" :class="open ? 'rotate-180' : ''">▼</span>
            </button>

            <!-- ISI COLLAPSE -->
            <div x-show="open" x-transition class="mt-3 space-y-4 rounded-lg bg-white p-4 shadow">
                ...
                <div>
                    ...
                    <form method="POST" action="{{ route('admin.absensi.lokasi') }}" class="space-y-3">
                        ...
                        <p class="text-xs text-orange-600">⚠ Perubahan lokasi langsung mempengaruhi absensi siswa</p>
