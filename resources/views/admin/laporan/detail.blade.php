...
<div class="p-6 space-y-6">
    ...
    <div class="rounded-xl border bg-white p-5 shadow">
        ...
        <p class="text-sm text-gray-600">
            ...
            Tanggal: <b>{{ \Carbon\Carbon::parse($tanggal)->format('d M Y') }}</b>
        </p>
    </div>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3 text-center">
                            <span class="rounded px-2 py-1 text-xs font-semibold
                                ...
                                @elseif ($row->status === 'izin') bg-blue-100 text-blue-700
                                @elseif ($row->status === 'sakit') bg-yellow-100 text-yellow-700
