...
<div class="p-6 max-w-5xl mx-auto space-y-8">
    ...
    <h1 class="text-2xl font-bold">Import & Export Siswa</h1>
    ...
    <div class="rounded-xl bg-white p-6 shadow">
        ...
        <form method="GET" action="{{ route('siswa.export') }}" class="space-y-4">
            ...
            <button class="rounded-lg bg-green-600 px-6 py-2 text-white hover:bg-green-700">
                Export Excel
            </button>
        </form>
    </div>
    ...
    <div class="rounded-xl bg-white p-6 shadow">
        ...
        >
            ...
            <button class="rounded-lg bg-blue-600 px-6 py-2 text-white hover:bg-blue-700">
                Import Siswa
            </button>
        </form>

        <div class="mt-4 rounded-lg bg-yellow-50 p-4 text-sm text-yellow-800">
            ⚠️ Siswa dengan NISN yang sudah ada akan dilewati otomatis.  
            Data absensi lama tidak akan terhapus.
        </div>
    </div>

    {{-- ================= UPDATE SISWA ================= --}}
    <div class="rounded-xl bg-white p-6 shadow border border-yellow-200">
        <h2 class="mb-2 text-lg font-semibold">Update Data Siswa per Kelas</h2>
        <p class="mb-4 text-sm text-gray-600">
            Gunakan fitur ini untuk memperbarui nama, username, atau password siswa
            tanpa mengubah kelas dan absensi.
        </p>
        ...
        <div class="mt-4 rounded-lg bg-yellow-50 p-4 text-sm text-yellow-800">
            ⚠️ Jangan ubah <b>siswa_id</b> dan <b>user_id</b>.  
