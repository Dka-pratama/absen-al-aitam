...
@section('content')
    ...
    <div>
        ...
        <input type="text" name="tahun" value="{{ $tahunAjar->tahun }}"
    ...
    <div>
        ...
        <select name="status" class="w-full rounded-lg border p-2 focus:ring" required>
            ...
            <option value="Non-Aktif" {{ $tahunAjar->status == 'Non-Aktif' ? 'selected' : '' }}>Non-Aktif</option>
        </select>
    </div>

    <button class="w-full rounded-lg bg-blue-600 p-2 text-white hover:bg-blue-700">
        Update
    </button>
</form>
