...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0"
    style="max-width:550px;background:#ffffff;border-radius:14px;padding:32px;
...
<td style="padding-bottom:25px;font-size:15px;color:#374151;line-height:1.6">
    Halo <strong>{{ $notification->notifiable->name ?? $notification->notifiable->username ?? 'User' }}</strong>
,<br><br>
...
<td align="center" style="padding-bottom:30px">
    <a href="{{ $actionUrl }}"
       style="background:linear-gradient(135deg,#01af61,#23db2e);
       color:white;padding:12px 28px;border-radius:8px;
       font-size:16px;text-decoration:none;display:inline-block;
       font-weight:bold;box-shadow:0 4px 10px rgba(0,150,80,0.3);">
        Reset Password
    </a>
</td>
</tr>
...
<td style="font-size:14px;color:#6b7280;line-height:1.5">
    Tautan ini berlaku selama <strong>60 menit</strong>.<br><br>
